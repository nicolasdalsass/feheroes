...
public class OrInheritanceRestrictionType implements InheritanceRestriction {
    public List<InheritanceRestriction> restrictions;

    public OrInheritanceRestrictionType(InheritanceRestriction... inheritanceRestrictionTypes) {
